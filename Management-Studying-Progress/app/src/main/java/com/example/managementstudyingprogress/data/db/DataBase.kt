...
// class with annotation Database is a starting point to room database
// he create and get access to DAO
...
// we set entitites which will be used in database as SubjectEntity and SubjectLabEntity
